...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoicnVzbGFuMTgzIiwiYSI6ImNsZ2FtcGN4bzFqNGEzdXBkcnR6YjhuaHIifQ.89-6vkpPvj_0Yo2_7QF91w";
...
exports.logout = exports.login = exports.authentification = void 0;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (result.data.status === "success") {
            ...
            (0, _alerts.showAlert)("success", "Enter confirmation code!");
            console.log(result.data.code);
            window.setTimeout(function () {
              location.assign("/authentification");
            }, 3000);
          }
          _context.next = 10;
          break;
...
exports.login = login;
var authentification = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://127.0.0.1:3000/api/v1/users/authentification",
            data: {
              code: code
            }
          });
  ...
  return function authentification(_x3) {
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe("pk_test_51MyB5DGddkqJyoJGrHKO6nZCuhHYAhTfHNaLlI4GhI1hZ5IX2xEsdyzpvFBNXivddAGwDoZvNYukGuJYOsrbiFDq00D8YVzJqM");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(startDate)
          });
        case 3:
...
var authentificationForm = document.querySelector(".form--authentification");
var logOutBtn = document.querySelector(".nav__el--logout");
var userDataForm = document.querySelector(".form-user-data");
var userPasswordForm = document.querySelector(".form-user-password");
var sectionCta = document.querySelector(".section-cta");
...
if (authentificationForm) {
  authentificationForm.addEventListener("submit", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _login.authentification)(code);
          case 4:
          case "end":
            return _context.stop();
        }
...
if (userDataForm) {
  userDataForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var name, email, photo, form, result, srcUserPhoto;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            event.preventDefault();
          ...
          case 13:
            srcUserPhoto = "/img/users/".concat(result.data.data.user.photo);
...
if (sectionCta) {
  sectionCta.addEventListener("click", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
      var btn, clearLocalStorageAndBody, _btn$dataset, tourId, startDate;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            btn = event.target.closest("#book-now");
            if (btn) {
              _context4.next = 3;
              break;
            }
          ...
          case 3:
            ...
            clearLocalStorageAndBody = function clearLocalStorageAndBody(event) {
              this.scroll(0, 0);
            ...
            _btn$dataset = btn.dataset, tourId = _btn$dataset.tourId, startDate = _btn$dataset.startDate;
            _context4.next = 9;
